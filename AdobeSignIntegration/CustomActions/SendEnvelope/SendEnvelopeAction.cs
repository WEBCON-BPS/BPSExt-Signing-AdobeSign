    ...
    public class SendEnvelopeAction : CustomAction<SendEnvelopeActionConfig>
    {
        ...
        public override async Task RunAsync(RunCustomActionParams args)
        {
            ...
            {              
                ...
                var docId = await api.SendDocumentAsync(content, $"{att.FileName}.{att.FileExtension}");                           
                var operationId = await api.SendToSigAsync(docId, Configuration.MessageContent.MailSubject, Configuration.MessageContent.MailBody, GetMembersInfo(args.Context.CurrentDocument.ItemsLists.GetByID(Configuration.Users.SignersList.ItemListId)));
